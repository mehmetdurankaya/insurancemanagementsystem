...
alanları bulunur. Ayrıca, "User" classta ArrayList tipinde adreslerinin tutulduğu bir liste bulunur.
Adres bilgisi iki tiptir. Ev adresi ("HomeAddress") ve İş adresi ("BusinessAddress") olmak üzere iki class tasarlayınız. 
